...
class GameStream:
    ...
    def iter_lines(self):
        yield b'{"id":"zzzzzzzz","variant":{"key":"standard","name":"Standard","short":"Std"},"clock":{"initial":60000,"increment":2000,"byoyomi":0,"periods":1},"speed":"bullet","perf":{"name":"Bullet"},"rated":true,"createdAt":1600000000000,"sente":{"id":"bo","name":"bo","title":"BOT","rating":3000},"white":{"id":"bo","name":"bo","title":"BOT","rating":3000},"gote":{"id":"b","name":"b","title":"BOT","rating":3000,"provisional":true},"black":{"id":"b","name":"b","title":"BOT","rating":3000,"provisional":true},"initialFen":"startpos","type":"gameFull","state":{"type":"gameState","moves":"","wtime":60000,"btime":60000,"winc":2000,"binc":2000,"status":"started"}}'
        time.sleep(1)
        while True:
            time.sleep(0.001)
            ...
            time.sleep(0.1)
            if event == 'end':
                yield eval('b\'' + f'{{"type":"gameState","moves":"{moves}","wtime":{int(wtime * 1000)},"btime":{int(btime * 1000)},"winc":2000,"binc":2000,"byo":0,"status":"outoftime","winner":"gote"}}' + '\'')
                break
            if moves:
                print('b\'' + f'{{"type":"gameState","moves":"{moves}","wtime":{int(wtime * 1000)},"btime":{int(btime * 1000)},"winc":2000,"binc":2000,"byo":0,"status":"outoftime","winner":"gote"}}' + '\'')
                yield eval('b\'' + f'{{"type":"gameState","moves":"{moves}","wtime":{int(wtime * 1000)},"btime":{int(btime * 1000)},"winc":2000,"binc":2000,"byo":0,"status":"started"}}' + '\'')
...
class Lishogi:
    ...
    def get_profile(self):
        profile = {'id': 'b', 'username': 'b', 'online': True, 'title': 'BOT', 'url': 'https://lishogi.org/@/bo', 'followable': True, 'following': False, 'blocking': False, 'followsYou': False}
